...
namespace RoosterCRM.DatabaseDataSetCompanyTableAdapters {
...
SELECT company_id, company_name, file_name, data FROM company WHERE (company_id = @company_id)";
        ...
        public virtual int Update(string company_name, string file_name, byte[] data, int Original_company_id, string Original_company_name, string Original_file_name, int company_id) {
            if ((company_name == null)) {
        ...
        public virtual int Update(string company_name, string file_name, byte[] data, int Original_company_id, string Original_company_name, string Original_file_name) {
            return this.Update(company_name, file_name, data, Original_company_id, Original_company_name, Original_file_name, Original_company_id);
        }
    }
